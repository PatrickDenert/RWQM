...
void setup() {
    ...
    //tds = 10.00;
    pinMode(7, INPUT);
    SD.begin(4);                //set chipselect pin to 4 and open SD serial port
}
...
byte SDCardWrite(String payload) {
    File file = SD.open("temp7.txt", FILE_WRITE);

  // if the file opened okay, write to it:
  if (file) {
    //Serial.print("Writing to temp2.txt...");
